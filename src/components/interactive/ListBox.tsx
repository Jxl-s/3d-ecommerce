...
export default function ListBox<T extends { display: string }>({
    ...
    return (
        <div className={className}>
            ...
            <div className={`w-full h-10 ${label && "mt-1"}`}>
                    ...
                    <div className="relative mt-1 z-10 w-full h-full">
                        ...
                        >
                            <Listbox.Options
                                ...
                                } max-h-60 w-full overflow-auto rounded-md bg-white dark:bg-neutral-900 py-1 shadow-md ring-1 ring-black/5 text-sm`}
                            >
                                {list.map((obj, i) => (
                                    <Listbox.Option
                                        key={i}
                                        className={({ active }) =>
                                            `relative cursor-pointer select-none py-2 pl-10 pr-4 duration-300 ${
                                                active
